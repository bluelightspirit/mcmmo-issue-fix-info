...
I say this because getSalvageItem() has a comment saying "@return The item that should get salvaged" while [this](https://mcmmo.fandom.com/wiki/Salvage) says "Salvage is the ability to reclaim the base materials from tools and armor. It is a child skill of Repair and Fishing, and it is calculated by averaging the two levels together" now. This means it is possible my issue was in consideration at a large scale rework of [McMMO](https://github.com/mcMMO-Dev/mcMMO). I do see several issues such as [this](https://github.com/mcMMO-Dev/mcMMO/issues/876) and [this](https://github.com/mcMMO-Dev/mcMMO/issues/2350) reported related to SuperBreaker efficiency, but not necessarily anvil/furnace efficiency being removed.
